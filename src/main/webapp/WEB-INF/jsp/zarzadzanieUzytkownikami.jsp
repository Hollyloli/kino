...
<div class="col-sm-12" id="divMain">
	...
	<form:form commandName="uzytkownik" class="form-horizontal" action="/PracaInz/formularzDodatniaRoli.html">
			<div class="form-group">
			<c:if test="${param.success eq true}">
				<div class="alert alert-success">Nadanie uprawnień użytkownikowi powiodło się</div>
			</c:if>
