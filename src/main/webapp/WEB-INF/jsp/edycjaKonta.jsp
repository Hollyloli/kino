...
<div class="col-sm-12">
	...
	<form:form commandName="polaczone" class="form-horizontal">
		...
		<c:forEach items="${uzytkownik.adresy}" var="adres" varStatus="loop">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<form:input path="adresy[${loop.index}].ulica"
						cssClass="form-control" value="${adres.ulica}" />
					<form:errors path="adresy[${loop.index}].ulica" />
				</div>
				<div class="col-sm-1">
					<form:input path="adresy[${loop.index}].numerMieszkania"
						cssClass="form-control" value="${adres.numerMieszkania}" />
					<form:errors path="adresy[${loop.index}].numerMieszkania" />
				</div>
				<div class="col-sm-2">
					<form:input path="adresy[${loop.index}].kodPocztowy"
						cssClass="form-control" value="${adres.kodPocztowy}" />
		...
		<c:forEach items="${uzytkownik.kontakty}" var="kontakt"
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<form:input path="kontakty[${loop.index}].telefon"
						cssClass="form-control" value="${kontakt.telefon}" />
	...
	<!-- Modal -->
	<form:form commandName="polaczone2" class="form-horizontal"
		action="/PracaInz/edycjaKonta2.html">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="miasto" class="col-sm-2 control-label">Numer
								mieszkania</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="miasto" class="col-sm-2 control-label">Numer
								mieszkania</label>
							<div class="col-sm-10">
								<form:input path="adresy[0].numerMieszkania"
									cssClass="form-control" />
								<form:errors path="adresy[0].numerMieszkania" />
							</div>
						</div>
						<div class="form-group">
							<label for="miasto" class="col-sm-2 control-label">Kod
								pocztowy</label>
							<div class="col-sm-10">
	...
	<form:form commandName="polaczone" class="form-horizontal"
		action="/PracaInz/edycjaKonta3.html">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Dodaj dane
							kontaktowe</h4>
					</div>
					<div class="modal-body">
						<div class="form-group">
						...
						<div class="form-group">
							<label for="ulica" class="col-sm-2 control-label">Numer
								Telefonu</label>
							<div class="col-sm-10">
